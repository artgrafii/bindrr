...
@section('content')
    <div class="flex flex-col gap-4">
        <p class="text-sm font-medium text-accent dark:text-emerald-300">404</p>
        <h1 class="text-3xl font-semibold tracking-tight">That page isn't in your spaces</h1>
        <p class="max-w-xl text-base leading-7 text-muted dark:text-stone-400">
            The link may be mistyped, or that space may not exist yet.
        </p>
        <div>
