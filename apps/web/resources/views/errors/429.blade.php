...
@section('content')
    <div class="flex flex-col gap-4">
        <p class="text-sm font-medium text-accent dark:text-emerald-300">429</p>
        <h1 class="text-3xl font-semibold tracking-tight">Too many requests</h1>
        <p class="max-w-xl text-base leading-7 text-muted dark:text-stone-400">
            Wait a moment, then try that again.
        </p>
        <div>
